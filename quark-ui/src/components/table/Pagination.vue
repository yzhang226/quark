  ...
  export default {
    ...
    computed: {
      ...
      totalPageNo: function () {
        ...
        // debugger;
        let totPage = parseInt(this.totalCount / this.pageSize);
      ...
      _currentPageNo: function () {
        ...
        // debugger;
        let pNo = parseInt(this.currentPageNo);
        if (parseInt(this.currentPageNo) > parseInt(this.totalPageNo)) {
          pNo = parseInt(this.totalPageNo);
        }
        return pNo;
      }
    },
